...
interface ProjectFilesJSON {
  manifest: ProjectManifestJSON;
  pages: Map<string /* file path */, PageJSON>;
}

export function projectJSONToFiles(projectJSON: ProjectJSON): ProjectFilesJSON {
...
export function filesToProjectJSON(files: ProjectFilesJSON): ProjectJSON {
