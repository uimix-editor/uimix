          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="grid grid-cols-3 gap-2 items-center">
              <InspectorNumberInput
                ...
                get={(s) => s.style.paddingTop[0]}
                set={(s, value) => {
                  s.style.paddingTop = [value ?? 0, "px"];
                }}
              />
              <InspectorNumberInput
                icon={{
                ...
                get={(s) => s.style.paddingRight[0]}
                set={(s, value) => {
                  s.style.paddingRight = [value ?? 0, "px"];
                }}
              />
              <InspectorNumberInput
                icon={{
                ...
                get={(s) => s.style.paddingBottom[0]}
                set={(s, value) => {
                  s.style.paddingBottom = [value ?? 0, "px"];
                }}
              />
              <InspectorNumberInput
                icon={{
                ...
                get={(s) => s.style.paddingLeft[0]}
                set={(s, value) => {
                  s.style.paddingLeft = [value ?? 0, "px"];
                }}
              />
              <StackAlignmentEdit
                direction={direction}
